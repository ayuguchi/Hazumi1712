...
#    plt.plot(start_time[1:], dif_au05, label='dif_AU05', marker='.')
    ...
    plt.plot(start_time[0:], e_20m1_int['0'], label='interest_level', marker='.', color='grey')
...
#    plt.plot(start_time[1:], dif_au05, label='dif_AU05', marker='.')
    plt.plot(start_time[1:], dif_au45, label='dif_AU45', marker='.')
    plt.plot(start_time[0:], e_20m2_int['0'], label='interest_level', marker='.', color='grey')
...
#    plt.plot(start_time[1:], dif_au05, label='dif_AU05', marker='.')
    plt.plot(start_time[1:], dif_au45, label='dif_AU45', marker='.')
    plt.plot(start_time[0:], e_20m3_int['0'], label='interest_level', marker='.', color='grey')
...
#    plt.plot(start_time[1:], dif_au05, label='dif_AU05', marker='.')
    plt.plot(start_time[1:], dif_au45, label='dif_AU45', marker='.')
    plt.plot(start_time[0:], e_20m4_int['0'], label='interest_level', marker='.', color='grey')
...
#    plt.plot(start_time[1:], dif_au05, label='dif_AU05', marker='.')
    plt.plot(start_time[1:], dif_au45, label='dif_AU45', marker='.')
    plt.plot(start_time[0:], e_20m5_int['0'], label='interest_level', marker='.', color='grey')
